...
int main(int argc, char *argv[])
{
  ...
  cout << "Pen lift count = " << p.numTimes(segments, 1) << " (1)" << endl
       << endl;
  ...
  segments.push_back("0 -10 0 0");
  segments.push_back("0 0 0 10");
  cout << "Pen lift count = " << p.numTimes(segments, 4) << " (0)" << endl
       << endl;
  ...
  cout << "Pen lift count = " << p.numTimes(segments, 1) << " (6)" << endl
       << endl;
  ...
  segments.push_back("-1 2 -6 2");
  cout << "Pen lift count = " << p.numTimes(segments, 5) << " (3)" << endl
       << endl;
  ...
  cout << "Pen lift count = " << p.numTimes(segments, 824759) << " (19)" << endl
       << endl;
}
